...
//line index.html:181
	qw422016.N().S(`"></b><b id="status-cinema" class="act hide-empty banner-float svg-link noscript-hide"></b><b id="thread-post-counters" class="act hide-empty banner-float svg-link noscript-hide" title="`)
//line index.html:183
...
//line index.html:288
	qw422016.N().S(`</div>`)
//line index.html:290
	qw422016.N().S(`<div id="cinema-panel" class="modal glass" style="display: none;"><div id="cinema-player"></div><div id="cinema-playlist"></div><div id="cinema-playlist-empty" hidden="">`)
//line index.html:295
	qw422016.N().S(ln.UI["cinemaPlaylistEmpty"])
//line index.html:295
