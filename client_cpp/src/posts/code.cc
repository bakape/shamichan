...
static bool is_keyword(const std::string& word)
{
    ...
    const static string keywords[] = { "NULL", "NaN", "abstract", "alias",
        ...
        "debugger", "decimal", "declare", "default", "defer", "deinit",
        "delegate", "delete", "do", "double", "echo", "elif", "else", "elseif",
        "elsif", "end", "ensure", "enum", "event", "except", "exec", "explicit",
        "export", "extends", "extension", "extern", "fallthrough", "false",
        "final", "finally", "fixed", "float", "fn", "for", "foreach", "friend",
        "from", "func", "function", "global", "go", "goto", "guard", "if",
        "impl", "implements", "implicit", "import", "in", "include", "inline",
        "inout", "instanceof", "int", "interface", "internal", "is", "lambda",
        "let", "lock", "long", "module", "mut", "mutable", "namespace",
        "native", "new", "next", "nil", "not", "null", "object", "operator",
        "or", "out", "override", "package", "params", "private", "protected",
        "protocol", "pub", "public", "raise", "readonly", "redo", "ref",
        "register", "repeat", "require", "rescue", "restrict", "retry",
