...
// Output the plural of a word, according to language semantics
export function pluralize(n, noun) {
	// For words ending with 'y' and not a vovel before that
	if (n !== 1
		&& noun.slice(-1) == 'y'
		&& ['a', 'e', 'i', 'o', 'u'].includes(noun.slice(-2, -1).toLowerCase())
	) {
...
// Capitalize a word, according to language semantics
